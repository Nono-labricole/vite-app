...
const EventCard = ({ title, date, description, image }: { title: string, date: string, description: string, image: string }) => (
  <div className="flex-none w-[191px] h-[239px] relative rounded-[25px] overflow-hidden border border-white/20 group cursor-pointer transition-all">
  ...
  return (
    <section className="mb-[32px]">
      <div className="px-[24px] mb-[24px]">
        ...
        <p className="text-[14px] text-white/50 font-light leading-[19px]">Active les rappels et ne rate aucuns événements !</p>
      </div>
